...
- Decided to deploy via the RMIT-provided AWS Academy Learner Lab, not a personal AWS account. **Superseded (2026-09-13)**: switched to a personal AWS account (Free Tier + $100 promotional credit) — see backend `docs/decisions/AWS_SETUP.md`.
...
1. ~~Confirm region~~ — done, kept as `us-east-1`.
