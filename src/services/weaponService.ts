...
// match, a shot-distance histogram from the same kill events, and a body-part hit-location
// breakdown from every hit this player landed as attacker. Not wired into mock mode: there's
// no mock telemetry fixture, and this call failing (404/network error) is an expected,
